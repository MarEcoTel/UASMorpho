...
// DAS made another edit to this script on 01/01/2023 when he commented out several of the output lines around line 250 in order to save space within the program and because these gps outputs are inaccurate and useless for our purposes
...
// testing to see if lidar tilt is returning same value as was seen to be an error earlier. uncomment this line and look at serial monitor to view results in arduino
